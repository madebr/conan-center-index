...
int main(int argc, char** argv)
{
    ...
    try {
        std::cerr << "Connecting to realm: " << DEFAULT_REALM << std::endl;

        boost::asio::io_service io;
        bool debug = false;

        boost::asio::ip::tcp::endpoint rawsocket_endpoint = boost::asio::ip::tcp::endpoint(
            boost::asio::ip::address::from_string(LOCALHOST_IP_ADDRESS), DEFAULT_RAWSOCKET_PORT);
