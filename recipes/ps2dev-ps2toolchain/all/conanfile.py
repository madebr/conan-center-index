...
class Ps2devPs2ToolchainConan(ConanFile):
    ...
    description = "binutils+gcc+newlib toolchain for Sony PlayStation 2"
    topics = "ps2", "toolchain", "binutils", "gcc", "newlib", "sony", "playstation", "ps2"
    settings = "os", "arch", "compiler", "build_type"

    def source(self):
        # FIXME: only download binutils patch + license from ps2toolchain?
    ...
    def _build_install_gcc(self, target, stage):
        ...
        if stage == 1:
            ...
            conf_args.extend([
                ...
                "--with-headers={}".format(os.path.join(self._ps2toolchain_path, target, target, "include")),
            ])
    ...
    def _build_install_newlib(self, target):
        ...
        # autotools.link_flags.append("-G0")
        # autotools.cpp.append("-G0")
